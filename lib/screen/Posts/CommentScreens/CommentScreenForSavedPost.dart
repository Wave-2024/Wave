...
class CommentScreenForSavedPosts extends StatefulWidget {
  ...
  CommentScreenForSavedPosts({this.postId, this.postOwner});

  @override
  State<CommentScreenForSavedPosts> createState() =>
      _postDetailForMyPostsState();
}

class _postDetailForMyPostsState extends State<CommentScreenForSavedPosts> {
  User? currentUser;
